...
\begin{column}{0.32\textwidth}\MMProblem{1}{Simplify \mbox{$x+x$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Simplify \mbox{$y+y+y$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Simplify \mbox{$2a+a$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Simplify \mbox{$5b-b$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Simplify \mbox{$3c+2c$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Simplify \mbox{$7d-3d$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Simplify \mbox{$4m+m$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Simplify \mbox{$6n-2n$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Simplify \mbox{$8p+p$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Simplify \mbox{$9q-4q$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Simplify \mbox{$2r+5r$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Simplify \mbox{$10s-s$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Simplify \mbox{$3t+4t$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Simplify \mbox{$12u-5u$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Simplify \mbox{$5v+2v$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Simplify \mbox{$11w-6w$}.}\end{column}
