...
\begin{column}{0.32\textwidth}\MMProblem{1}{Simplify: \mbox{$14-3\times2+5$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Simplify: \mbox{$18\div3\times2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Simplify: \mbox{$(9+7)\div4$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Simplify: \mbox{$6+2\times(5-1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Evaluate: \mbox{$3\times4+18\div6$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{When \mbox{$x=3$}, simplify \mbox{$2x+5$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Fill in: \mbox{$2+3\times(6-2)=\rule{1.6cm}{0.15mm}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Is \mbox{$(4+5)\times2=14$} correct? Explain briefly.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Complete: \mbox{$12\div3+4=\rule{1.6cm}{0.15mm}$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Evaluate: \mbox{$2(7+1)-5$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Which is greater: \mbox{$3+4\times2$} or \mbox{$(3+4)\times2$}?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Write one short rule for order of operations.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
