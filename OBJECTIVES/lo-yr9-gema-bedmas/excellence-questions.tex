...
\begin{column}{0.32\textwidth}\MMProblem{2}{Simplify: \mbox{$6+24\div3\times2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Simplify: \mbox{$5(7-3)+2^3$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{When \mbox{$x=4$}, simplify \mbox{$3x+2^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{A student says \mbox{$2+6\div3\times4=10$}. Are they correct? Explain.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{A student says \mbox{$3(4+2)-5=13$}. Are they correct? Explain.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Simplify: \mbox{$3^2+4\times5-6$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Write brackets so that \mbox{$6+2\times5$} has value \mbox{$40$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Evaluate: \mbox{$5+3^2$} and explain order used.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Push Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{When \mbox{$p=5$}, simplify \mbox{$2(p-1)+3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Explain in one short sentence why multiplication and division have same precedence.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Complete: \mbox{$2+3\times4-1=\rule{1.6cm}{0.15mm}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
