...
\begin{column}{0.32\textwidth}\MMProblem{1}{Write an equation for: "x plus 3 equals 8".}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{If a number \mbox{$n$} plus 5 equals 12, write the equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Let \mbox{$t$} be the number of apples; write an expression for 2 more than \mbox{$t$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Write an equation: "a number plus 7 equals 14".}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{If \mbox{$m$} is a number and \mbox{$m-4=6$}, write \mbox{$m$} as an equation and solve.}\end{column}
