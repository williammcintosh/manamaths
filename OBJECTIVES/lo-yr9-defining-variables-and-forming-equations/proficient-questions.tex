...
\begin{column}{0.32\textwidth}\MMProblem{1}{Write an equation for: "three times a number is 15".}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Translate: "the total of \mbox{$m$} and 4 is 9".}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{A box has \mbox{$b$} marbles. Add 7 to make 20. Write an equation and solve.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Write and solve: "twice a number plus 3 equals 11".}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Choose a variable for: "the difference between a number and 5 is 10".}\end{column}
