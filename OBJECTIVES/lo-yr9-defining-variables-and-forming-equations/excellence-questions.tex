...
\begin{column}{0.32\textwidth}\MMProblem{1}{A student writes \mbox{$2x-3=11$} for "twice a number decreased by 3 is 11". Are they correct? Solve.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Let the first of two consecutive numbers be \mbox{$n$}. Write an equation if their sum is 17, then solve.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Write an equation for: "three less than a number equals twice another number" and give an example.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
