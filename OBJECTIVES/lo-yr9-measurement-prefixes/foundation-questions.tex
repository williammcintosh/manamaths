...
\begin{column}{0.32\textwidth}\MMProblem{1}{What unit would you use to measure the length of your hand? (m/cm/mm)}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Which is bigger: 1 km or 500 m?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Convert 2500 m to km.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Convert 0.75 m to cm.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Fill in: 1000 m = \rule{1.6cm}{0.15mm} km.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Which unit for mass of a person: g or kg?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{How many grams are in 3 kilograms?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Convert 5000 g to kg.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Explain in one short sentence what a prefix does.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Put these in order smallest to largest: mm, m, km.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{A length is 120cm. Write in metres.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Convert 75 cm to mm.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
