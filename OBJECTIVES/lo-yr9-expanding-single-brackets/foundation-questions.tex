...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$2(x+3)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$3(a+4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$4(y+2)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$5(m+1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$6(p+2)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$2(b+7)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$3(c+5)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$7(d+1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$4(2x+1)$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$3(2y+4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$5(a+6)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$2(3m+2)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$4(n+5)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$3(4p+1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$2(q+9)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$5(r+3)$}.}\end{column}
