...
\begin{column}{0.32\textwidth}\MMProblem{1}{Expand \mbox{$(x+2)(x+3)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Expand \mbox{$(x+1)(x+4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Expand \mbox{$(x+5)(x+2)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Expand \mbox{$(x+6)(x+1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Expand \mbox{$(a+2)(a+5)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Expand \mbox{$(a+3)(a+4)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Expand \mbox{$(y+1)(y+7)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Expand \mbox{$(y+2)(y+6)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Expand \mbox{$(m+3)(m+3)$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Expand \mbox{$(p+4)(p+4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Expand \mbox{$(b+2)(b-1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Expand \mbox{$(c+5)(c-2)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Expand \mbox{$(n-1)(n+4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Expand \mbox{$(r-3)(r+2)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Expand \mbox{$(q-2)(q-5)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Expand \mbox{$(t-4)(t-1)$}.}\end{column}
