...
\begin{column}{0.32\textwidth}\MMProblem{1}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Write the equation in the form \mbox{$y=a(x-h)^2+k$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
