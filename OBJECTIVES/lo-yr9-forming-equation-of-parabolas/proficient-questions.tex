...
\begin{column}{0.32\textwidth}\MMProblem{1}{Equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Equation.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Equation.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Equation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Equation.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
