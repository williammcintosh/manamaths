...
\begin{column}{0.32\textwidth}\MMProblem{1}{Write \mbox{$x^2\times x^3$} as one power.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Write \mbox{$a^4\times a^2$} as one power.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Write \mbox{$m^5\times m$} as one power.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Simplify \mbox{$y^7\div y^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Simplify \mbox{$b^6\div b^5$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Simplify \mbox{$p^9\div p^3$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Simplify \mbox{$(k^3)^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Simplify \mbox{$(c^4)^3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Simplify \mbox{$(n^2)^5$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Fill in: \mbox{$q^2\times q^5=q^{\square}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Fill in: \mbox{$r^8\div r^3=r^{\square}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Fill in: \mbox{$(t^6)^2=t^{\square}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{True or false: \mbox{$s^3\times s^4=s^7$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{True or false: \mbox{$(w^2)^3=w^6$}.}\end{column}
