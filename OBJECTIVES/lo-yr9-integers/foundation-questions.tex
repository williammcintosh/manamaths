...
\begin{column}{0.32\textwidth}\MMProblem{1}{What is the opposite of \mbox{$-7$}?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Which of these are integers: \mbox{$3, -5.5, 0, 1/2$}?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Calculate: \mbox{$-3 + 5$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Calculate: \mbox{$7 - (-2)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Fill in: \mbox{$-4 + \rule{1.6cm}{0.15mm} = 0$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Order these from smallest to largest: \mbox{$-2, 0, 3$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{A temperature is \mbox{$-4^\circ$}C. It rises by \mbox{$10^\circ$}C. What is the new temperature?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Which is greater: \mbox{$-1$} or \mbox{$-5$}?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Complete: \mbox{$(-3)+(-4)=\rule{1.6cm}{0.15mm}$}.}\end{column}
\end{columns}
\end{frame}
...
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Add: \mbox{$5 + (-2)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Subtract: \mbox{$-1 - 3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Explain in one short sentence what an integer is.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
