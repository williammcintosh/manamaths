...
\begin{column}{0.32\textwidth}\MMProblem{1}{Calculate: \mbox{$-8 + 12$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Calculate: \mbox{$7 - (-9)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Evaluate: \mbox{$-3 \times 4$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Evaluate: \mbox{$-12 \div 3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Put in order: \mbox{$-10, -2, 0, 5, -7$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{A diver starts at \mbox{$-12$} m, ascends 3 m, then descends 5 m. What is the final depth?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{True or False: a negative number plus a negative number is always negative.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Fill in the blank: \mbox{$-15 + \rule{1.6cm}{0.15mm} = -5$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Which is closer to 3: \mbox{$2.9$} or \mbox{$3.1$}? (interpretation question)}\end{column}
\end{columns}
\end{frame}
...
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Explain a short rule for adding a negative number.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Calculate: \mbox{$-4 - (-6)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Round: (conceptual) is rounding negative integers done same as positives? Short answer.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
