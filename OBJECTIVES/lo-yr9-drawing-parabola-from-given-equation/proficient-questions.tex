...
\begin{column}{0.32\textwidth}\MMProblem{1}{Draw \mbox{$ y=(x-2)^2-1 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Draw \mbox{$ y=(x+3)^2+2 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Draw \mbox{$ y=-(x-1)^2+4 $}. Label the turning point.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Draw \mbox{$ y=2(x+1)^2-2 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Draw \mbox{$ y=-\frac{1}{2}(x-2)^2+3 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Draw \mbox{$ y=x^2-2x-3 $}. Label the turning point.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Draw \mbox{$ y=x^2+4x+1 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Draw \mbox{$ y=-x^2+2x+3 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Draw \mbox{$ y=2x^2-4x-6 $}. Label the turning point.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Draw \mbox{$ y=\frac{1}{2}x^2+2x-1 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Draw \mbox{$ y=x^2-6x+5 $}. Label the turning point.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Draw \mbox{$ y=-x^2-4x $}. Label the turning point.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
