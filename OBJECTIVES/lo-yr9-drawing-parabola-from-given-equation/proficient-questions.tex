...
\boldmath
{\LARGE \textbf{Drawing parabola from given equation — Proficient}}\\[0.2em]
{\large Use the numbered blank grids. Draw each parabola carefully and label the turning point.}
\begin{center}
...
\begin{tasks}(3)
\task Draw \mbox{$ y=(x-2)^2-1 $}. Label the turning point.
\task Draw \mbox{$ y=(x+3)^2+2 $}. Label the turning point.
\task Draw \mbox{$ y=-(x-1)^2+4 $}. Label the turning point.
\task Draw \mbox{$ y=2(x+1)^2-2 $}. Label the turning point.
\task Draw \mbox{$ y=-\frac{1}{2}(x-2)^2+3 $}. Label the turning point.
\task Draw \mbox{$ y=x^2-2x-3 $}. Label the turning point.
\task Draw \mbox{$ y=x^2+4x+1 $}. Label the turning point.
\task Draw \mbox{$ y=-x^2+2x+3 $}. Label the turning point.
\task Draw \mbox{$ y=2x^2-4x-6 $}. Label the turning point.
\task Draw \mbox{$ y=\frac{1}{2}x^2+2x-1 $}. Label the turning point.
\task Draw \mbox{$ y=x^2-6x+5 $}. Label the turning point.
\task Draw \mbox{$ y=-x^2-4x $}. Label the turning point.
\end{tasks}
\end{document}
