...
\task Draw \mbox{$ y=(x+2)^2-1 $}. Also mark where it crosses the \mbox{$x$}-axis.
\task Draw \mbox{$ y=-(x-4)^2+2 $}. Also mark where it crosses the \mbox{$x$}-axis.
\task Draw \mbox{$ y=x^2+2x-8 $}. Also mark where it crosses the \mbox{$x$}-axis.
\task Draw \mbox{$ y=-x^2+4x-1 $}. Also mark where it crosses the \mbox{$x$}-axis.
