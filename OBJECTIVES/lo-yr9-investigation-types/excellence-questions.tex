...
\begin{column}{0.32\textwidth}\MMProblem{1}{Design a summary investigation question about school life.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Design a comparison investigation question about sports.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Design a relationship investigation question about health.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Design a time-series investigation question about weather.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Explain when you would use each investigation type.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Critique: ``Is height vs weight a comparison investigation?''}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Which variables would you measure for each investigation type?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{How does the investigation type affect data collection?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Create a statistical question for each investigation type.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Push Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Match graphs to investigation types with justification.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Plan data collection for each investigation type.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Evaluate which investigation type is most appropriate for given scenarios.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
