...
\begin{column}{0.32\textwidth}\MMProblem{1}{Identify the investigation type: ``Average height of Year 9 students''}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Identify: ``Comparing test scores before and after a study program''}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Identify: ``Relationship between study hours and test marks''}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Identify: ``Monthly sales figures for a shop''}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Give an example of a summary investigation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Give an example of a comparison investigation.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Give an example of a relationship investigation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Give an example of a time-series investigation.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Which graph is best for a summary investigation?}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Which graph is best for a comparison investigation?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Which graph is best for a relationship investigation?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Which graph is best for a time-series investigation?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
