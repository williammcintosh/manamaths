...
\begin{column}{0.32\textwidth}\MMProblem{1}{Distribution of test scores.\\
\histogram{0-20/2,21-40/6,41-60/12,61-80/9,81-100/5}\\
Estimate the median score and explain.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Sales before and after a promotion.\\
\barchart{Before/45/45,After/68/68}\\
Calculate the percentage increase.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Ages of survey participants.\\
\histogram{10-19/8,20-29/15,30-39/22,40-49/18,50-59/7}\\
What is the modal class? Estimate the mean age.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Monthly energy use in kWh.\\
\barchart{Jan/320/32,Feb/290/29,Mar/310/31,Apr/280/28,May/260/26,Jun/240/24}\\
Describe the trend and suggest a reason.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Average test scores for three classes.\\
\barchart{A/76/76,B/82/82,C/79/79}\\
If each class has 25 students, what is the overall average?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Annual rainfall in mm for five years.\\
\barchart{Y1/1200/120,Y2/980/98,Y3/1100/110,Y4/1050/105,Y5/1150/115}\\
Calculate the interquartile range.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
