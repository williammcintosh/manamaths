...
\begin{column}{0.32\textwidth}\MMProblem{1}{Solve: \mbox{$x + 3 > 7$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Solve: \mbox{$2x < 10$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Solve: \mbox{$y - 4 \le 6$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Solve: \mbox{$3p \ge 12$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Solve: \mbox{$\frac{a}{2} > 5$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Solve: \mbox{$b + 7 \le 15$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Solve: \mbox{$4c < 20$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Solve: \mbox{$d - 2 \ge 8$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Solve: \mbox{$5e > 25$}}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Solve: \mbox{$\frac{f}{3} \le 4$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Solve: \mbox{$g + 5 > 12$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Solve: \mbox{$6h \le 30$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Solve: \mbox{$k - 3 < 9$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Solve: \mbox{$7m \ge 21$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Solve: \mbox{$\frac{n}{4} > 3$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Solve: \mbox{$p + 8 \le 20$}}\end{column}
