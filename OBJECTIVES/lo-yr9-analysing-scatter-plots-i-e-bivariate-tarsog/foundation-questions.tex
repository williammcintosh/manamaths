...
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Identify the trend (linear or non-linear) for each plot above.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Identify the association (positive or negative) for each plot above.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Identify the relationship strength (weak, moderate, strong) for each plot above.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Identify the scatter (constant or non-constant) for each plot above.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Identify any outliers in the plots above.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Identify any groupings in the plots above.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{What does TARSOG stand for?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Match each letter of TARSOG with its meaning.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Given a scatter plot with a positive linear trend and strong relationship, describe what that means.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Given a scatter plot with a negative linear trend and moderate relationship, describe what that means.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Given a scatter plot with a non-linear trend and weak relationship, describe what that means.}\end{column}
