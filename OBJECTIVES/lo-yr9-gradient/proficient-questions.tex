...
\begin{column}{0.32\textwidth}\MMProblem{1}{Gradient from \mbox{$(1,2)$} to \mbox{$(5,4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Gradient from \mbox{$(-2,3)$} to \mbox{$(2,-3)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Gradient from \mbox{$(4,-1)$} to \mbox{$(8,5)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Gradient from \mbox{$(-3,-2)$} to \mbox{$(1,0)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Rise \mbox{$3$}, run \mbox{$2$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Fall \mbox{$5$}, run \mbox{$4$}. Gradient?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Rise \mbox{$7$}, run \mbox{$5$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Fall \mbox{$9$}, run \mbox{$2$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Table \mbox{$(0,-1),(2,2),(4,5),(6,8)$}. Gradient?}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Table \mbox{$(-1,5),(1,2),(3,-1),(5,-4)$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Pattern \mbox{$2,2.5,3,3.5,\dots$}. Change?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Pattern \mbox{$20,18.5,17,15.5,\dots$}. Change?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
