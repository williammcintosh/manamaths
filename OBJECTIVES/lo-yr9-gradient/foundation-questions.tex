...
\begin{column}{0.32\textwidth}\MMProblem{1}{Rise \mbox{$1$}, run \mbox{$1$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Rise \mbox{$2$}, run \mbox{$1$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Fall \mbox{$1$}, run \mbox{$1$}. Gradient?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Fall \mbox{$3$}, run \mbox{$1$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Gradient from \mbox{$(0,1)$} to \mbox{$(1,3)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Gradient from \mbox{$(2,4)$} to \mbox{$(3,6)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Gradient from \mbox{$(1,5)$} to \mbox{$(2,4)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Gradient from \mbox{$(-1,2)$} to \mbox{$(0,-1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Table \mbox{$(0,2),(1,4),(2,6),(3,8)$}. Gradient?}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Table \mbox{$(0,7),(1,4),(2,1),(3,-2)$}. Gradient?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Pattern \mbox{$6,10,14,18,\dots$}. Change?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Pattern \mbox{$15,12,9,6,\dots$}. Change?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Does gradient \mbox{$5$} go up or down?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Gradient of \mbox{$y=4$}?}\end{column}
