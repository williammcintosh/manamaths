...
\begin{column}{0.32\textwidth}\MMProblem{1}{Factorise \mbox{$x^2+5x+6$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Factorise \mbox{$x^2+7x+10$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Factorise \mbox{$x^2+9x+20$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Factorise \mbox{$x^2+11x+24$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Factorise \mbox{$a^2+8a+15$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Factorise \mbox{$a^2+6a+8$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Factorise \mbox{$y^2+3y+2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Factorise \mbox{$y^2+10y+21$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Factorise \mbox{$m^2-5m+6$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Factorise \mbox{$m^2-7m+12$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Factorise \mbox{$p^2-9p+20$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Factorise \mbox{$p^2-11p+24$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Fill in the blank: \mbox{$x^2+8x+15=(x+\square)(x+\square)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Fill in the blank: \mbox{$n^2-9n+20=(n-\square)(n-\square)$}.}\end{column}
