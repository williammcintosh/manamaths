...
\begin{column}{0.32\textwidth}\MMProblem{1}{Factorise \mbox{$x^2+6x+9$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Factorise \mbox{$x^2+10x+25$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Factorise \mbox{$a^2+8a+16$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Factorise \mbox{$y^2+14y+49$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Factorise \mbox{$m^2-4m+4$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Factorise \mbox{$p^2-12p+36$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Factorise \mbox{$b^2-2b+1$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Factorise \mbox{$c^2-18c+81$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Factorise \mbox{$x^2-16$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Factorise \mbox{$a^2-25$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Factorise \mbox{$y^2-49$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Factorise \mbox{$m^2-81$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Fill in: \mbox{$x^2+12x+36=(x+\square)^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Fill in: \mbox{$p^2-64=(p-\square)(p+\square)$}.}\end{column}
