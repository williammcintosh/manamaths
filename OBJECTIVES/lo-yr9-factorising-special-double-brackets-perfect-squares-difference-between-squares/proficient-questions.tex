...
\begin{column}{0.32\textwidth}\MMProblem{1}{Factorise \mbox{$x^2+18x+81$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Factorise \mbox{$a^2-14a+49$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Factorise \mbox{$4y^2+12y+9$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Factorise \mbox{$9m^2-24m+16$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Factorise \mbox{$25p^2-1$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Factorise \mbox{$4b^2-49$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Factorise \mbox{$36c^2-d^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Factorise \mbox{$49r^2-81$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Fill in: \mbox{$x^2-20x+100=(x-\square)^2$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Fill in: \mbox{$16a^2-b^2=(\square a-b)(\square a+b)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Correct? \mbox{$x^2-36=(x-6)^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Odd one out: \mbox{$y^2-9$}, \mbox{$(y-3)(y+3)$}, \mbox{$(y-9)(y+1)$}, \mbox{$3^2$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
