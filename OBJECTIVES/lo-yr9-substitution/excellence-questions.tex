...
\begin{column}{0.32\textwidth}\MMProblem{1}{A student says when \mbox{$x=2$}, \mbox{$x^3+x=10$}. Are they correct? Explain.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{When \mbox{$x=1$} and \mbox{$y=2$}, evaluate \mbox{$2x+3y$} and state which is larger.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Substitute \mbox{$x=3$} into \mbox{$2x^2+1$} and show working.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{When \mbox{$p=5$}, simplify \mbox{$2(p-1)+3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{If \mbox{$x=4$} and \mbox{$y=-1$}, evaluate \mbox{$3x+2y^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Substitute into brackets with powers: when \mbox{$x=2$}, evaluate \mbox{$(x+1)^2$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Use substitution to evaluate \mbox{$3x+2^2$} when \mbox{$x=4$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{When \mbox{$a=3$} and \mbox{$b=2$}, simplify \mbox{$a^2+b\times4$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Explain when substitution must respect order of operations.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Push Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Create one challenge substitution question and provide its answer.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Explain how substitution can be used to check an algebraic solution.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Evaluate \mbox{$x^3+x$} when \mbox{$x=-1$} and interpret the result.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
