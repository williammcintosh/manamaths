...
\begin{column}{0.32\textwidth}\MMProblem{1}{Evaluate when \mbox{$x=3$}: \mbox{$2x^2+1$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Evaluate when \mbox{$m=2$} and \mbox{$n=3$}: \mbox{$m+n^2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{When \mbox{$x=4$}, evaluate \mbox{$(6x+12)\div3$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Substitute \mbox{$x=5$} into \mbox{$3(x+2)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{When \mbox{$y=4$}, simplify \mbox{$3y-2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Evaluate when \mbox{$a=2$} and \mbox{$b=5$}: \mbox{$a+b\times2$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Fill in: when \mbox{$x=4$}, \mbox{$3x=\rule{1.6cm}{0.15mm}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{When \mbox{$m=6$}, simplify \mbox{$(m+2)\div2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Is \mbox{$x=2$} a solution to \mbox{$2x+1=5$}? Check.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Substitute \mbox{$x=3$} into \mbox{$2x+5$} and give the result.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Explain substitution for one-variable expressions in one short sentence.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Evaluate \mbox{$5x-2y$} when \mbox{$x=2,\ y=-4$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
