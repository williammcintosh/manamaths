...
\begin{column}{0.32\textwidth}\MMProblem{2}{Evaluate when \mbox{$y=2$}: \mbox{$2y$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Evaluate when \mbox{$a=5$}: \mbox{$a-2$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Evaluate when \mbox{$n=4$}: \mbox{$3n+1$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{If \mbox{$x=1$}, find \mbox{$2x+3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Substitute \mbox{$x=2$} into \mbox{$x^2+1$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{When \mbox{$m=0$}, evaluate \mbox{$m+5$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{When \mbox{$t=4$}, evaluate \mbox{$2t-1$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Check: is \mbox{$x=3$} a solution to \mbox{$x+2=5$}?}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Fill in: when \mbox{$x=4$}, \mbox{$3x=\rule{1.6cm}{0.15mm}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Explain one short rule for substitution.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Give one example of substituting into a bracket: \mbox{$(x+2)$} when \mbox{$x=3$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
