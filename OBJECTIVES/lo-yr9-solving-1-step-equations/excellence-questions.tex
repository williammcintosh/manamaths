...
\begin{column}{0.32\textwidth}\MMProblem{1}{Solve and check: \mbox{$\dfrac{1}{2}x=9$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Write and solve: a number plus 4 equals 13.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Solve and check: \mbox{$-3x=9$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
