...
\begin{column}{0.32\textwidth}\MMProblem{2}{Solve: \mbox{$n-4=6$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Solve: \mbox{$2a=10$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Solve: \mbox{$m\div 5=3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Check your solution for \mbox{$x+2=5$} by substitution.}\end{column}
