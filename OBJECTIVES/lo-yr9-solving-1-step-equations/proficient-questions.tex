...
\begin{column}{0.32\textwidth}\MMProblem{1}{Solve: \mbox{$3x=12$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Solve: \mbox{$y-7=2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Solve: \mbox{$\dfrac{z}{4}=5$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Is \mbox{$x=3$} a solution to \mbox{$2x+1=7$}? Explain.}\end{column}
