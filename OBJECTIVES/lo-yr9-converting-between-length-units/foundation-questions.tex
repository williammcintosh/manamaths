...
\begin{column}{0.32\textwidth}\MMProblem{1}{Convert 2 m to cm.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Convert 30 mm to cm.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Convert 4 km to m.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Convert 250 cm to m.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Convert 9000 mm to m.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Convert 7 m to mm.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Convert 3.5 km to m.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Convert 120 cm to mm.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{A ribbon is 80 cm long. Write the length in mm.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{A desk is 1.2 m long. Write the length in cm.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{A road is 6 km long. Write the length in m.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{A pencil is 150 mm long. Write the length in cm.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Which is longer: 950 m or 1 km?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Explain why 1 m = 100 cm.}\end{column}
