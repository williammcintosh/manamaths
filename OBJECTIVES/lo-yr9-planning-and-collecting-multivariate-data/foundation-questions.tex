...
\begin{column}{0.32\textwidth}\MMProblem{1}{Is 'height' a categorical or numerical variable?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Is 'favourite colour' a categorical or numerical variable?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{What is multivariate data?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{What is a sample?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Give an example of a statistical question.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{In a study about student study habits, identify one categorical variable.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{In the same study, identify one numerical variable.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{What is a sampling method?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Name one sampling method.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{What is bias in data collection?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Give an example of bias.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Why is random sampling important?}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{What is a population?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{What makes a question a 'statistical question'?}\end{column}
