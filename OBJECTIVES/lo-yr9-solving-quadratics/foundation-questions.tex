...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$x^2+5x+6=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$x^2+7x+12=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$x^2-5x+6=0$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$x^2-9x+20=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$a^2+3a+2=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$a^2-4a+3=0$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$y^2+y-12=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$y^2-y-6=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$m^2+8m+15=0$}}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$m^2-2m-15=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$p^2=(5p)-6$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$q^2+2q=15$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$(r+4)(r-1)=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$(t-6)(t+2)=0$}}\end{column}
