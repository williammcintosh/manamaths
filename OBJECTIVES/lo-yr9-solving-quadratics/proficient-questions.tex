...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$x^2+x-20=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$x^2-11x+24=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$x^2-3x-28=0$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$x^2+9x+14=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$a^2+6a-16=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$a^2-7a+10=0$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$b^2+2b=35$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$b^2-8b=-12$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$y(y+9)=22$}}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$m(m-4)=32$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$(p+7)(p-3)=0$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$(q-5)(q-1)=0$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
