...
\begin{column}{0.32\textwidth}\MMProblem{1}{Write \mbox{$2\times2\times2\times2$} as a power and evaluate it.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Calculate \mbox{$5^{3}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Find \mbox{$\sqrt{36}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{Evaluate \mbox{$3^{4}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Explain why \mbox{$4^{2}$} and \mbox{$2^{4}$} are different.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Fill in: \mbox{$2^{5} = \rule{1.6cm}{0.15mm}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{If \mbox{$a=3$}, evaluate \mbox{$a^{3}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Which is larger: \mbox{$2^{6}$} or \mbox{$3^{4}$}? Show working.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Express \mbox{$81$} as a power of \mbox{$3$}.}\end{column}
\end{columns}
\end{frame}
...
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Calculate \mbox{$10^{2}$} and \mbox{$10^{3}$} and explain the pattern.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Take square roots: \mbox{$\sqrt{49}$} and \mbox{$\sqrt{64}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Write \mbox{$16$} as \mbox{$2^n$} and state \mbox{$n$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
