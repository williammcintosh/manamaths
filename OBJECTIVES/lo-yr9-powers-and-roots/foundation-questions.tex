...
\begin{column}{0.32\textwidth}\MMProblem{1}{Write \mbox{$2\times2\times2\times2$} using a power.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{What is \mbox{$2^{3}$}?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Evaluate \mbox{$3^{2}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{What is the square root of \mbox{$25$}?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{Is \mbox{$\sqrt{4}$} rational or irrational?}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{Write \mbox{$4^{1}$} as a number.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Fill in: \mbox{$3^{2} = \rule{1.6cm}{0.15mm}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{Calculate: \mbox{$2\times2\times2$} and express as a power.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{Put these in order: \mbox{$2^{2}, 2^{3}, 2^{1}$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{Complete: \mbox{$\rule{1.6cm}{0.15mm}^{2} = 49$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{Explain in one short sentence what a power represents.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Give an example of a cube number.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
