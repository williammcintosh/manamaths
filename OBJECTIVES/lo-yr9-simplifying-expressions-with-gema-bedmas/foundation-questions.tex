...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$3+4\times 2$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$5+6\div 3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$9-2\times 4$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$18\div 3+7$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$(8+2)\times 3$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$20\div (4+1)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$7+3\times 5$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$24\div 6+8$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$15-3\times 2$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$4\times (6-1)$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$(12-5)+9$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$30\div (3\times 2)$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$2+3\times 4-1$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$5\times (2+3)-4$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$16\div 4+2\times 3$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{Which is correct: \mbox{$2+5\times 3=21$} or \mbox{$2+5\times 3=17$}?}\end{column}
