...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$\frac{1}{2}+\frac{1}{4}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$\frac{3}{4}-\frac{1}{8}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$\frac{2}{3}+\frac{1}{6}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$\frac{5}{6}-\frac{1}{3}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$\frac{3}{5}+\frac{1}{10}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$\frac{7}{8}-\frac{1}{4}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$\frac{2}{9}+\frac{4}{3}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$\frac{11}{12}-\frac{1}{6}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$\frac{3}{7}+\frac{2}{14}$}.}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$\frac{5}{6}-\frac{1}{12}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$\frac{4}{15}+\frac{2}{5}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$\frac{7}{10}-\frac{1}{5}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$\frac{5}{12}+\frac{1}{3}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$\frac{13}{18}-\frac{1}{9}$}.}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$\frac{3}{4}+\frac{5}{12}$}.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$\frac{7}{9}-\frac{1}{6}$}.}\end{column}
