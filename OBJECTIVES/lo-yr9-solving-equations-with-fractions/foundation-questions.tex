...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$\dfrac{x}{2}=5$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$\dfrac{a}{3}=4$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$\dfrac{m}{4}=3$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$\dfrac{p}{5}=7$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$\dfrac{b}{2}+3=8$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$\dfrac{c}{3}+1=6$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$\dfrac{d}{4}-2=5$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$\dfrac{e}{5}+4=9$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$\dfrac{2f}{3}=10$}}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Start Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$\dfrac{3g}{4}=9$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$\dfrac{5h}{2}=20$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$\dfrac{3k}{5}=12$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$\dfrac{x+3}{2}=7$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$\dfrac{n-4}{3}=5$}}\end{column}
