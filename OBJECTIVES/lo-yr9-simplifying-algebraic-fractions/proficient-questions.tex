...
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$\dfrac{6x+12}{6}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$\dfrac{10y-5}{5}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{\mbox{$\dfrac{12a^2}{18a}$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{4}{\mbox{$\dfrac{14m^2n}{21mn}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{5}{\mbox{$\dfrac{x^2+5x}{x}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{6}{\mbox{$\dfrac{3y^2-6y}{3y}$}}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{7}{\mbox{$\dfrac{4a^2b}{2ab}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{8}{\mbox{$\dfrac{15p^2q}{5pq}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{9}{\mbox{$\dfrac{x^2-9}{x-3}$}}\end{column}
\end{columns}
\end{frame}
\begin{frame}[t]
\WorksheetTitle{Build Tasks}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMProblem{1}{\mbox{$\dfrac{y^2+4y}{y}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{2}{\mbox{$\dfrac{6m^2-24m}{12m}$}}\end{column}
\begin{column}{0.32\textwidth}\MMProblem{3}{Simplify \mbox{$\dfrac{2a^2b+6ab}{4ab}$}. State any restrictions.}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
