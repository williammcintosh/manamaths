...
\begin{tasks}(3)
\task \mbox{Explain whether $\frac{14}{21}$ and $\frac{2}{3}$ are equivalent.}
\task \mbox{Explain whether $\frac{18}{24}$ and $\frac{3}{5}$ are equivalent.}
\task One fraction is $\frac{3}{4}$. Write three different equivalent fractions.
\task \mbox{Fill in both blanks: $\frac{\square}{12} = \frac{3}{4} = \frac{21}{\square}$}
...
\task \mbox{Explain whether $\frac{15}{20}$ and $\frac{9}{12}$ are equivalent.}
\task \mbox{Fill in both blanks: $\frac{\square}{18} = \frac{2}{3} = \frac{16}{\square}$}
\end{tasks}
