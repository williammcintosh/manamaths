...
\task Write a fraction equivalent to $\frac{5}{6}$.
\task Are $\frac{2}{8}$ and $\frac{1}{4}$ equivalent?
\task Fill in the blank: $\frac{3}{5} = \frac{12}{\square}$
\task Write a fraction equivalent to $\frac{6}{7}$.
\task {
