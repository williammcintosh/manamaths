...
def classify_layout(tex: str) -> tuple[int, str, str]:
    ...
    if average_score >= 2.2 or average_words >= 5.2:
        return 3, '6.6em', f'wordy avg_score={average_score:.2f} avg_words={average_words:.2f}'
    return 3, '5.9em', f'numeric avg_score={average_score:.2f} avg_words={average_words:.2f}'
